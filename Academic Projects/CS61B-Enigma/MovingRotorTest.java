...
public class MovingRotorTest {
    ...
    public void checkRotorAtB() {
        setRotor("I", NAVALB, "");
        checkRotor("Rotor I (A)", UPPER_STRING, NAVALB_MAP.get("I"));
    }

    @Test
    public void checkRotorAtZ() {
        setRotor("I", NAVALZ, "");
        checkRotor("Rotor I (A)", UPPER_STRING, NAVALZ_MAP.get("I"));
    }
    ...
    @Test
    public void checkRotorAdvance01() {
        setRotor("I", NAVALZ, "");
        rotor.advance();
    ...
    @Test
    public void checkNotch01() {
        setRotor("I", NAVALA, "O");
        rotor.set(11);
        assertNotEquals(true, rotor.atNotch());
    }

    @Test
    public void checkNotch02() {
        setRotor("I", NAVALA, "J");
        rotor.set(9);
        assertEquals(true, rotor.atNotch());
    }
    ...
    @Test
    public void checkRotorSet01() {
        setRotor("I", NAVALB, "");
        rotor.set(25);
        checkRotor("Rotor I set", UPPER_STRING, NAVALA_MAP.get("I"));
    }

    @Test
    public void checkRotorSet02() {
        setRotor("I", NAVALZ, "");
        rotor.set(2);
        checkRotor("Rotor I set", UPPER_STRING, NAVALB_MAP.get("I"));
    }
